...
shot  = MultiStepForward(pos_rec, src[1], fidMtx, tmax=2.0)
SeisPlot(shot.d, pclip=95, cmap="PuOr")

dp = dpDirect(shot, v[1], src[1], dx, dt)
shot.d = dp .* shot.d
SeisPlot(shot.d, cmap="PuOr")
...
MultiStepForward(pathsrc, src, fidMtx_sm, tmax=1.0)
...
SeisPlot(Ivz, cmap="PuOr", pclip=98)
SeisPlot(Ivx, cmap="PuOr", pclip=98)
