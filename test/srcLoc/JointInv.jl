...
SeisPlot(readSrcSpt(path_adj, 46))

path_x = "/Users/wenlei/Desktop/x.bin"
path_s = "/Users/wenlei/Desktop/s.bin"
path_p = "/Users/wenlei/Desktop/p.bin"
CGjoint(ntw, path_x, path_s, path_p, shot, fidMtx, pos_rec, tmax=0.5, mu=0.1, niter=20)
...
# SeisPlot(readSrcSpt(path_adj, 10), dx=10, dy=10, xlabel="Length", xunits="(m)", ylabel="Depth", yunits="(m)")
# =============the result of adjoint================================
